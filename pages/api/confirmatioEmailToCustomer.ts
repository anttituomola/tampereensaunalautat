...
Päivämäärä: ${dayjs(tenderSummary.date).tz('Europe/Helsinki').format("DD.MM.YYYY")}
...
tampereensaunalautat.fi`,
      ...
      Subject: {
        Data: "Tarjouspyyntö lähetetty: " + dayjs(tenderSummary.date).tz('Europe/Helsinki').format("DD.MM.YYYY"),
      },
    },
